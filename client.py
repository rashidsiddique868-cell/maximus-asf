...
class TrafficControlEnv(
    EnvClient[TrafficControlAction, TrafficControlObservation, State]
):
    """
    ...
    Example:
        ...
        >>> with TrafficControlEnv(base_url="http://localhost:8000") as client:
        ...     result = client.reset()
        ...     print(result.observation.echoed_message)
        ...
        ...     result = client.step(TrafficControlAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = TrafficControlEnv.from_docker_image("traffic_control_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(TrafficControlAction(message="Test"))
        ... finally:
        ...     client.close()
    """
    ...
    def _step_payload(self, action: TrafficControlAction) -> Dict:
        ...
        Args:
            action: TrafficControlAction instance
    ...
    def _parse_result(self, payload: Dict) -> StepResult[TrafficControlObservation]:
        ...
        Returns:
            StepResult with TrafficControlObservation
        """
